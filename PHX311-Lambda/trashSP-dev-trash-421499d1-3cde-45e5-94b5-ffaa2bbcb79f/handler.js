...
async function scraper(address,attempt){
  var url = "https://mapapps.phoenix.gov/imap/imap.html";
    ...
    if(data === false && attempt < 2){
      ...
      msg = "Para la recogida de basura en " + address + ", su basura será recogida en " + data[0].value + " y el reciclaje será recogido " + data[1].value + "."
...
module.exports.trashSP = async event => {
