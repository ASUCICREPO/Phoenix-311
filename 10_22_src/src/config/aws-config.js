...
const aws_bots_config = '[{"name":"PhoenixChatBot","alias":"$LATEST","description":"Bot to order flowers.","bot-template":"bot-flowers","commands-help":["I would like to pick up flowers","I would like to order some flowers","Buy flowers"],"region":"us-east-1"}]';
const aws_cognito_identity_pool_id = 'us-east-1:3399d173-bbcc-49f3-8251-d29d534b7f30';
